...
Promise.all(assets).then(function (images) {
    ...
    document.getElementsByClassName('journal-reward')[0].addEventListener('click', function () {
        ...
        stage.bubble(images[random.uniformDiscrete(0, images.length - 1)], 2000);
    ...
    document.getElementsByClassName('journal-reward')[0].addEventListener('mousedown', function () {
        ...
        time = setInterval(function () {
            ...
            if (timeEnd - timeStart > 1000) {
                ...
                stage.bubble(images[random.uniformDiscrete(0, images.length - 1)], 1000);
            }
        }, 50);

    }, false);
    document.getElementsByClassName('journal-reward')[0].addEventListener('mouseup', function () {
